...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary:
      "bg-brand-navy dark:bg-slate-100 text-white dark:text-brand-navy hover:bg-slate-800 dark:hover:bg-white focus:ring-brand-navy",
    secondary:
    ...
    outline:
      "border border-slate-200 dark:border-slate-700 bg-transparent text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 focus:ring-slate-500",
    danger:
